...
def create_pdf(data):
    ...
    pdf.multi_cell(190, 5, "Notice: This report is a simulation based on KPX rules and V-GEN's optimization algorithm. Actual returns may vary depending on weather and grid conditions.")
...
st.info("💡 팁: 사이드바에서 수치를 조정한 후 리포트를 다운로드하면 실시간 결과가 반영됩니다.")
